...
// Type: Helicopter.CompLaunchableHelicopter
...
namespace Helicopter
{
  ...
  public class CompLaunchableHelicopter : ThingComp
  {
    ...
    private void StartChoosingDestination()
    {
      ...
      Find.WorldTargeter.BeginTargeting(new Func<GlobalTargetInfo, bool>(this.ChoseWorldTarget), true, CompLaunchableHelicopter.TargeterMouseAttachment, true, (Action) (() => GenDraw.DrawWorldRadiusRing(tile, this.MaxLaunchDistance)), (Func<GlobalTargetInfo, string>) (target =>
      {
        if (!target.IsValid)
          return (string) null;
